...
mod tests {
    ...
    fn can_create_with_correct_number_of_bytes() {
        can_create_byte_array_with_correct_number_of_bytes::<Address>(25);
    }
    ...
    fn can_create_from_string() {
        ...
        // Arrange:
        let encoded_address = "TCFGSLITSWMRROU2GO7FPMIUUDELUPSZUNUEZF33";
        let decoded = HEXUPPER
            .decode(b"988A692D13959918BA9A33BE57B114A0C8BA3E59A3684C977B")
            .unwrap();
